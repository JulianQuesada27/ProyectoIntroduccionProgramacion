...
import com.mycompany.Biblioteca.Reporte;
import com.mycompany.Biblioteca.Usuario;
import com.mycompany.Biblioteca.Consultas;  // 
...
public class ProyectoIntroduccionProgramacion {
    ...
    static Reporte reporte = new Reporte(listaLibros, listaPrestamos, listaDevoluciones);
    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            //  === CONSULTAS ===
                ...
                Consultas.menuConsultas(listaLibros, contLibros,
                                         listaUsuarios, contUsuarios,
                                         listaPrestamos, contPrestamos,
                                         listaDevoluciones, contDevoluciones);
            }
